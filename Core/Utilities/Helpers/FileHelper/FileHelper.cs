...
namespace Core.Utilities.Helpers.FileHelper
{
    public class FileHelper
    {
        public IDataResult<string> CreateFile(IFormFile file, string directoryPath)
        {
            ...
            {
                return new ErrorDataResult<string>("Dosya ismi boş olamaz.");
            }
            ...
            return new SuccessDataResult<string>(filePath, "Dosya Başarıyla Oluşturuldu");
        }
        public IResult DeleteFile(string filePath)
        {
            ...
            {
                return new ErrorResult("Dosya Yolu Bulunamadı.");
            }
